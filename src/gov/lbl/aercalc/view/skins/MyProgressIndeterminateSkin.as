...
package gov.lbl.aercalc.view.skins
{
	 ...
	 */
	public class MyProgressIndeterminateSkin extends Border
	{		
		//--------------------------------------------------------------------------
		//
		//  Constructor
		 ...
		 *  @productversion Flex 4
		 */
		public function MyProgressIndeterminateSkin()
		{
			super();
		}	
		...
		private static var colors:Array = [0x5690d9, 0x0c64d3];
		...
		override protected function updateDisplayList(w:Number, h:Number):void
		{
			...
			for (var i:int = 0; i < w; i += hatchInterval)
			{
				...
				g.moveTo(i, 2);
				g.lineTo(Math.min(i + 17, w), 2);
				g.lineTo(Math.min(i + 13, w), h - 2);
